...
class Blockchain:
    ...
    def add_transaction(self, factoryID, factoryName, timestamp, types, name, value):
        data1 = "{\"factoryID\":" + "\""+ str(factoryID) + "\"" + ",\"factoryName\":"  + "\"" + str(factoryName)  + "\"" + ",\"timestamp\":" + str(timestamp) + ",\"sensors\":[{\"type\":"  + "\""+ str(types)  + "\""+ ",\"name\":"  + "\""+ str(name)  + "\""+ ",\"value\":" + str(value) + "}]}"
...
def add_transaction():
    ...
    index = blockchain.add_transaction(json['factoryID'] , json['factoryName'] , json['timestamp'] ,json['sensors'][0]['type'], 
                                       json['sensors'][0]['name'],json['sensors'][0]['value'])
